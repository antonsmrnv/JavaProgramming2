...
public class MyOffers {
    ...
    public static void main(String[] args) {
       ...
       offer5.setInfo("WA", "Bank Of America", "BA", 130000, true, true, false, true);
        ...
        localOffers.removeIf( p-> !(p.location.equals("VA") || p.location.equals("CA") ) ); //remove if the offer is NOT from VA or CA
        System.out.println(localOffers.size());

        for (Offer localOffer : localOffers) {
            System.out.println(localOffer.companyName + " : " + localOffer.salary);  //can use for-each loop for pulling up specifics of variables
        }
